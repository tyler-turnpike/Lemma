...
<!--
Modified for the Lemma repository (vendored from getsentry/skills@c2f99a5b04b4cd992ec3022d7c2c3e23e938d241):
"Bash" was removed from allowed-tools so that shell commands are not pre-approved while this
skill is active. No other change. See ../SOURCES.md.
-->
